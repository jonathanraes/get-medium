defmodule GetMedium.Truncated do
  @moduledoc """
  This module returns a truncated version of your Medium blog posts. It requires
  your Medium RSS URL (see blog_posts_truncated/2 for details), and the number
  of characters to truncate at. The default value is set to 304 (305 characters
  when zero indexed). This will truncate your content at 305 characters, then
  trim that down passed the last space " ".
  ...
  @doc """
  Using a URL created by RSS2JSON for your Medium blog, returns a list of your
  blog posts. Other services to get JSON for your Medium feed might work but
  the structure could be different and break the app.

  Publications have a feed format of https://medium.brianemorycom/feed and
  personal feeds have a format of https://medium.com/feed/@thebrianemory. Using
  the URL and https://rss2json.com, you will get your feed in a JSON format.

  Using RSS2JSON, you will get a URL for your API call. You will use that URL
  to fetch your feed in a JSON format. With RSS2JSON, you can use just your feed
  URL or you can register and use your API key to add more options like order by,
  order direction, and items count.

  https://api.rss2json.com/v1/api.json?rss_url=https%3A%2F%2Fmedium.brianemory.com%2Ffeed&api_key=YOUR_API_KEY&count=3
  ...
  ## Examples
      ...
      [%{categories: ["programming", "coding", "elixir", "web-development"],
       ...
       %{categories: ["learning", "elixir", "programming", "goals",
          "web-development"],
       ...
       %{categories: ["programming", "elixir", "education", "phoenix",
          "web-development"],
